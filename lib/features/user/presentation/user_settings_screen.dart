...
class UserSettingsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final name = user?.displayName ?? 'Attendee';
    final email = user?.email ?? '';
    final initials = name.isNotEmpty ? name[0].toUpperCase() : 'A';

    return Scaffold(
      appBar: const EsAppBar(title: 'Profile & Settings'),
              ...
              child: Column(
                children: [
                  ...
                  SwitchListTile(
                    ...
                    subtitle: const Text('Wait for Wi-Fi to upload'),
                    value: wifiSync,
                    onChanged: (value) {
            ...
            Container(
              ...
              child: ListTile(
                ...
                onTap: () async {
                  ...
                  // For anonymous attendees, log them out
                  if (context.mounted) {
